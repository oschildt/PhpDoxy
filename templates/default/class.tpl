...
<!-- foreach uses_traits -->
{item}<br>
<!-- endforeach uses_traits -->
</div>
<!-- endif uses_traits -->

<!-- if known_inheritances -->
<h2>Known inheritances</h2>
<div class="item_list">
<!-- foreach known_inheritances -->
{item}<br>
<!-- endforeach known_inheritances -->
</div>
<!-- endif known_inheritances -->
...
<!-- if detailed_constants -->
  <!-- foreach detailed_constants -->
  <hr id="{object_anchor}">
  ...
  <!-- endforeach detailed_constants -->
<!-- endif detailed_constants -->

<!-- if detailed_properties -->
  <!-- foreach detailed_properties -->
  <hr id="{object_anchor}">
  ...
  <!-- endforeach detailed_properties -->
<!-- endif detailed_properties -->
