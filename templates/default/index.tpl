...
<!-- if packages -->
  <table id="packages" class="table table-responsive table-bordered table-striped">
      <tr><th>Packages</th></tr>
      
      <!-- foreach packages -->
      <tr>
          <td>
              <a href="{package_link}">{package_name}</a>
          </td>
      </tr>
      <!-- endforeach packages -->
...
<!-- if globals -->
  <table id="globals" class="table table-responsive table-bordered table-striped multicolumn">
      <tr><th colspan="3">Global variables</th></tr>
      
      <!-- foreach globals -->
      <tr>
          <td>
              <a href="{global_link}">{global_name}</a>
          </td>
