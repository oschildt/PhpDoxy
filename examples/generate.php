...
function generate(): void
{
    ...
    try {
        $config_file = __DIR__ . DIRECTORY_SEPARATOR . "phpdoxy_config.xml";

        if (!file_exists($config_file)) {
            throw new \Exception("The config file 'phpdoxy_config.xml' was not provided in the script directory '" . __DIR__ . "'!");
        }
        ...
        do {
            ...
            $config["source"] = __DIR__ . DIRECTORY_SEPARATOR . $orig_source;
            if (file_exists($config["source"])) {
                break;
            }
        ...
        do {
            ...
            $target_parent = __DIR__ . DIRECTORY_SEPARATOR . $orig_target_parent;
            if (file_exists($target_parent)) {
                break;
            }
...
//    PhpDocWatcher::trackERror("Error 1");
//    PhpDocWatcher::trackERror("Error 2");
//    PhpDocWatcher::trackWarning("War 1");
//    PhpDocWatcher::trackWarning("War 2");
