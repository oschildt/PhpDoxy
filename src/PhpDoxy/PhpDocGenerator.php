...
class PhpDocGenerator
{
    ...
    protected function renderMenu(&$layout_contents, $file_name)
    {
        ...
        if (preg_match("/<!-- foreach menuitem -->(.*?)<!-- endforeach menuitem -->/ism", $menu_contents, $matches)) {
            ...
            if (!empty($this->dictionary["classes"])) {
                $item = $matches[1];
            ...
            if (!empty($this->dictionary["interfaces"])) {
                $item = $matches[1];
            ...
            if (!empty($this->dictionary["traits"])) {
                $item = $matches[1];
            ...
            if (!empty($this->dictionary["functions"])) {
                $item = $matches[1];
            ...
            if (!empty($this->dictionary["constants"])) {
                $item = $matches[1];
            ...
            if (!empty($this->dictionary["global_variables"])) {
                $item = $matches[1];
            ...
            if (!empty($this->dictionary["todos"]) ||
                !empty($this->dictionary["since"]) ||
                !empty($this->dictionary["deprecated"])) {
                $item = $matches[1];
